...
def set_pixels(pixel_buff, pixels_per_string, elapsed_time, palette, audio_level, audio_respond, colour_mash):
    for ii in range(len(pixel_buff)):
        ...
        pixel_val = tuple(pixel_level * channel for channel in palette_utils.get_value(elapsed_time, ii, pixels_per_string, palette, colour_mash))
